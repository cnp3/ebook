...
extensions = ['sphinx.ext.todo', 'sphinx.ext.graphviz', 'sphinx.ext.mathjax', 'interactive_syllabus_directives','sphinxcontrib.tikz','sphinxcontrib.spelling', 'sphinxcontrib.mscgen']
